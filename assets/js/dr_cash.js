document.getElementById('healthinlife_profitclicks_max').addEventListener('submit', function (event) {
    event.preventDefault();

    const form = document.getElementById('healthinlife_profitclicks_max');
